 ...
 request(options, function (error, response, body) {
    if (!error && response.statusCode == 200) {
        ...
        name = info.displayName;
         ...
         var msg = {
           "type": "text",
           "text": "##แจ้งเตือนจุดเสี่ยง##" +"\n"+ "\n\tขณะนี้คุณ"+" " +name +" " + "อยู่ในบริเวณปากซอยสุขุมวิท 4 (นานา) ซึ่งเป็นจุดเสี่ยงที่มีการก่อเหตุล้วงกระเป๋าบ่อยครั้ง ขอให้ท่านโปรดระวังทรัพย์สินของท่านให้รัดกุมมากยิ่งขึ้น" + "\n"  + "\nด้วยความปราถนาดี" + "\nจาก พ.ต.อ.กัมพล รัตนประทีป" + "\nผู้กำกับการ สถานีตำรวจนครบาลลุมพินี"
          }; 
